...
const[prevUrl,setPrevUrl]=useState('');
  ...
  async function downloadPokemons() {
    setIsLoading(true)
    const response = await axios.get(pokedexUrl);//this downloads list of pokemon
...
//passing promise array  to axios  all
    const pokemonData = await axios.all(pokemonPromise);//array of pokemon detailed data
   console.log(pokemonData)

//now iterate data of each pokemon  extract their id name image
